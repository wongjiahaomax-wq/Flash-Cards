...
function wireCurrent(meta) {
  ...
  document.querySelectorAll('textarea').forEach(element => { fitTextarea(element); element.addEventListener('input', () => fitTextarea(element)); });
