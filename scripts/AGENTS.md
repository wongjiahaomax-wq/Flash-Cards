...
Use `docs/AGENT_TASK_MAP.md` to select the relevant runbook. Validation-authoring and CI-diagnostic changes additionally require the authorities routed there.

Tool/runtime changes require focused tests and `npm run runtime:smoke` when the changed-file contract identifies them as runtime-sensitive.
