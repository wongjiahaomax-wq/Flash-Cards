...
export const reviews = sqliteTable(
  'reviews',
  {
    ...
    // The D1 migration enforces this FK to tags. Declaring it here would
    // create a schema.js <-> tag-schema.js module cycle for one nullable
    // Review-level provenance field.
