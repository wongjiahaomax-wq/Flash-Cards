...
import {
  addPreviewAssetsToStimulusGroup as addPreviewAssetsToStimulusGroupStimulus,
  addPreviewStimulusOption as addPreviewStimulusOptionStimulus,
  convertPreviewFixedAssetToOption as convertPreviewFixedAssetToOptionStimulus,
  createPreviewStimulusGroup as createPreviewStimulusGroupStimulus,
  movePreviewStimulusOption as movePreviewStimulusOptionStimulus,
  setPreviewStimulusOptionActive as setPreviewStimulusOptionActiveStimulus,
  startPreviewAlternativeSet as startPreviewAlternativeSetStimulus,
  updatePreviewStimulusGroup as updatePreviewStimulusGroupStimulus,
  updatePreviewStimulusOptionCaption as updatePreviewStimulusOptionCaptionStimulus,
  validatePreviewStimulusGroupTarget as validatePreviewStimulusGroupTargetStimulus
} from './preview-workspace/stimulus.ts';
...
export async function validatePreviewStimulusGroupTarget(db, previewSessionId, groupId) {
  return validatePreviewStimulusGroupTargetStimulus(db, previewSessionId, groupId);
}
...
export async function addPreviewAssetsToStimulusGroup(db, previewSessionId, groupId, assetIds) {
  const group = await validatePreviewStimulusGroupTargetStimulus(db, previewSessionId, groupId);
  return addPreviewAssetsToStimulusGroupStimulus(db, previewSessionId, group, boundedPreviewAssetIds(assetIds));
}
...
export async function updatePreviewStimulusOptionCaption(db, previewSessionId, caseId, optionId, captionMd) {
  return updatePreviewStimulusOptionCaptionStimulus(db, previewSessionId, caseId, optionId, captionMd);
}
...
export async function createPreviewStimulusGroup(db, previewSessionId, caseId, input) {
  return createPreviewStimulusGroupStimulus(db, previewSessionId, caseId, input);
}
...
export async function startPreviewAlternativeSet(db, previewSessionId, caseId, assetId, name) {
  return startPreviewAlternativeSetStimulus(db, previewSessionId, caseId, assetId, name);
}
...
export async function updatePreviewStimulusGroup(db, previewSessionId, groupId, input) {
  return updatePreviewStimulusGroupStimulus(db, previewSessionId, groupId, input);
}
...
export async function addPreviewStimulusOption(db, previewSessionId, groupId, assetId, captionMd = null) {
  return addPreviewStimulusOptionStimulus(db, previewSessionId, groupId, assetId, captionMd);
}
...
export async function convertPreviewFixedAssetToOption(db, previewSessionId, groupId, assetId) {
  return convertPreviewFixedAssetToOptionStimulus(db, previewSessionId, groupId, assetId);
}
...
export async function setPreviewStimulusOptionActive(db, previewSessionId, optionId, active) {
  return setPreviewStimulusOptionActiveStimulus(db, previewSessionId, optionId, active);
}
...
export async function movePreviewStimulusOption(db, previewSessionId, groupId, optionId, direction) {
  return movePreviewStimulusOptionStimulus(db, previewSessionId, groupId, optionId, direction);
}
