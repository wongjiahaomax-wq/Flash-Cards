<script>
  ...
  /** @typedef {{ id: string, name: string }} NamedOption */
...
<style>
  ...
  @media(max-width:1200px){.filter-panel{grid-template-columns:repeat(3,minmax(0,1fr))}.search-field{grid-column:1/-1}.bulk-bar{grid-template-columns:1fr 1fr}}@media(max-width:700px){.page-heading,.panel-heading{align-items:start;flex-direction:column}.filter-panel{grid-template-columns:repeat(2,minmax(0,1fr))}.search-field,.filter-actions{grid-column:1/-1}.collection-create{align-items:stretch;flex-direction:column}.collection-create form{align-items:stretch;flex-direction:column}.collection-create input{min-width:0}.asset-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.bulk-bar{grid-template-columns:1fr}.pagination{grid-template-columns:auto 1fr auto;font-size:.85rem}}@media(max-width:430px){.asset-grid{grid-template-columns:1fr}}
</style>
