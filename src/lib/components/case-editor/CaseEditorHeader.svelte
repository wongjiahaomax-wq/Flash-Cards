<script>
  let { selectedCase, previewMode, studyPreviewHref = null } = $props();
</script>
...
<section class="page-heading">
  ...
  <div class="actions"><a class="button" href="/admin/cases">All Cases</a>{#if previewMode}<span class="muted">Learner Study is unavailable in Preview Mode.</span>{:else}<a class="button primary" href={studyPreviewHref ?? '/study'}>Preview in Study</a>{/if}</div>
</section>
