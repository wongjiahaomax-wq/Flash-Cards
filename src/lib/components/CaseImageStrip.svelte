...
<style>
  ...
  .strip-item { position: relative; display: grid; grid-template-rows: 105px auto; flex: 0 0 clamp(155px, 21vw, 220px); scroll-snap-align: start; min-width: 0; padding: 0; overflow: hidden; border: 1px solid #dfe5ee; border-radius: 8px; background: #fff; color: #172033; text-align: left; cursor: pointer; }
  ...
  @media (max-width: 620px) {
    ...
    .strip-item { flex-basis: min(72vw, 205px); }
  }
</style>
