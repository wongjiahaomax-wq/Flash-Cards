...
export const demoCases = {
  ...
  'pityriasis-rosea': {
    ...
    questions: [
      ...
      {
        prompt: 'What is the initial lesion shown?',
        answer: 'A herald patch.',
        scope: 'Case-specific answer',
      },
      {
        prompt: 'What later cutaneous pattern is shown in the second image?',
        answer: 'A subsequent truncal eruption.',
        scope: 'Case-specific answer',
      },
    ],
  ...
  'lichen-planus': {
    ...
    questions: [
      ...
      {
        prompt: 'Which cutaneous site is represented in the first image?',
        answer: 'The wrist.',
        scope: 'Case-specific answer',
      },
      {
        prompt: 'Which mucosal site is represented in the second image?',
