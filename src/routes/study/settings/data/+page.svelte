...
<main class="shell data-shell">
  <header class="page-header"><div><p class="eyebrow">Study</p><h1>Manage Study data</h1><p class="muted">Reset or remove your study history and scheduling. Your saved Study session is cleared when needed.</p></div><div class="page-actions"><a class="button" href="/study/settings">Study settings</a><a class="button" href="/study">← Back to Study</a></div></header>
  ...
  {:else}
    ...
    <section class="settings-card">
      <div><p class="eyebrow">Fresh scheduling start</p><h2>Reset scheduling and learning settings</h2><p class="muted">Starts scheduling fresh with the default 90% retention target. Your past activity remains.</p></div>
    ...
    <section class="deletion-card">
      <div><p class="eyebrow">Permanent deletion</p><h2>Delete all my study data</h2><p class="muted">Removes completed Reviews, ratings, scheduling state, Free Study history, and associated learning analytics. Your account and preferences remain active. This cannot be undone.</p></div>
